    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: `O responsável pelo tratamento é ${e.legalName} (${e.tradingName}), com sede em ${formatAddressInline(e)}, NIF ${e.nif}, email ${e.email}.`,
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: `The controller is ${e.legalName} (${e.tradingName}), ${formatAddressInline(e)}, NIF ${e.nif}, ${e.email}.`,
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: `Verantwortlich: ${e.legalName} (${e.tradingName}), ${formatAddressInline(e)}, NIF ${e.nif}, ${e.email}.`,
          },
        ],
      },
      {
