...
function cloneRequestLocale(request: NextRequest, locale: Locale) {
...
export function proxy(request: NextRequest) {
  ...
  if (isPrefixedLocaleSegment(firstSegment)) {
    ...
    const requestHeaders = cloneRequestLocale(request, locale);
  ...
  const requestHeaders = cloneRequestLocale(request, "en");
